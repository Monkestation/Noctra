...
/obj/structure/fake_machine/merchantvend
	...
	var/list/unlocked_cats = list("Apparel","Armor","Food","drinks","Jewelry","luxury","Tools","Seeds","Shields","Medicine","Raw Materials",
								"Weapons (Iron)","Weapons (Steel)","Weapons (Ranged&Explosives)","Ammunition")
