/datum/advclass/combat/vikingr
	name = "Elven Vikingr"
	tutorial = "A wandering searaider, a Vikingr from the Elven Clans of Kaledon. \
	You are locked in a fierce rivalry with your other kin, those sea elves, those coastal elves, \
	you hate whichever one is not you. You will see them die. Abyysor's bounty is what you seek, and you shall have it."
