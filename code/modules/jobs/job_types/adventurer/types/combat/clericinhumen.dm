...
/datum/advclass/combat/inhumencleric
	name = "Inhumen Cleric"
	tutorial = "These Clerics are wandering warriors of the Inhumen gods"
...
/datum/outfit/job/adventurer/inhumencleric/pre_equip(mob/living/carbon/human/H)
	...
	switch(H.patron?.type)
		...
		if(/datum/patron/inhumen/baotha)
			...
			H.adjust_skillrank(/datum/skill/combat/knives, 2, TRUE)//better than the Eora counterpart because... well I think they need the extra help
			H.adjust_skillrank(/datum/skill/craft/alchemy, 2, TRUE)
