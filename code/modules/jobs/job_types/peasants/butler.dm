...
/datum/outfit/job/butler/pre_equip(mob/living/carbon/human/H)
	...
	H.adjust_skillrank(/datum/skill/labor/mathematics, 4, TRUE) // Educated, also commonly the one who actually goes and buys ingredients. Someone who's been in charge of servants for a while should probably understand money well.
