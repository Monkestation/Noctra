...
/datum/advclass/town_elder/mayor
	name = "Mayor"
	if (H.race = RACES_PLAYER_NONDISCRIMINATED)
	...
	else // different backstory that indicates that you're not a noble.
...
/datum/outfit/job/town_elder/mayor/pre_equip(mob/living/carbon/human/H)
	...
	if (H.race == RACES_PLAYER_NONDISCRIMINATED) // Only humen-adjacent species get to be nobles, sorry!
